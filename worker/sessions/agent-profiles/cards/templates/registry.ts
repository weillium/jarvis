...
const definitionTemplate: TemplateDefinitionFactory = () => ({
  ...
  slots: [
    ...
    {
      id: 'definition',
      description: 'Plain-language definition or explanation.',
      required: true,
      strategy: 'hybrid',
      maxLength: 320,
    },
    {
      id: 'why_now',
      description: 'One sentence explaining why the audience needs this now.',
      required: true,
      strategy: 'deterministic',
      maxLength: 160,
    },
    {
      id: 'visual_prompt',
      description: 'Optional prompt for a supporting visual.',
      required: false,
      strategy: 'llm',
      maxLength: 180,
    },
...
const summaryTemplate: TemplateDefinitionFactory = () => ({
  ...
  slots: [
    ...
    {
      id: 'bullets',
      description: '1-3 bullet points capturing the core ideas.',
      required: true,
      strategy: 'hybrid',
      maxLength: 420,
    },
    {
      id: 'visual_prompt',
      description: 'Optional prompt for a supporting visual or diagram.',
      required: false,
      strategy: 'llm',
      maxLength: 180,
    },
