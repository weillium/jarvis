...
/**
 * Formats a date string using a consistent format that avoids hydration mismatches.
 * Uses a locale-independent format that works consistently on both server and client.
 */
